// Imagine that you’re a top singer, and fans ask day and 
// night for your upcoming song.
...
// And even if something goes very wrong, say, a fire in the studio, 
// so that you can’t publish the song, they will still be notified.

// Everyone is happy: you, because the people don’t crowd you anymore, 
// and fans, because they won’t miss the song.
...
// When it is finished with the attempt it calls resolve if it was 
...
// to produce the result. This changes the state of the promise object:
...
// To summarize, the executor should perform a job 
// (usually something that takes time) and then call 
...
// calls resolve/reject after some time, but it doesn’t have to. 
...
// For instance, this might happen when we start to do a job 
// but then see that everything has already been completed and cached.
